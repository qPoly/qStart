...
<template>
    <div class="space-y-6">
        <Heading variant="small" title="Account verwijderen" description="Verwijder je account en alle bijbehorende gegevens" />
        <div class="space-y-4 rounded-lg border border-red-100 bg-red-50 p-4 dark:border-red-200/10 dark:bg-red-700/10">
            <div class="relative space-y-0.5 text-red-600 dark:text-red-100">
                <p class="font-medium">Waarschuwing</p>
                <p class="text-sm">
                    Wees voorzichtig, deze actie kan niet ongedaan worden gemaakt.
                </p>
            </div>
            <Dialog>
                ...
                <DialogContent>
                    <Form v-bind="ProfileController.destroy.form()" reset-on-success @error="() => passwordInput?.focus()" :options="{
                        preserveScroll: true,
                        ...
                        <div class="grid gap-2">
                            ...
                            <PasswordInput id="password" name="password" ref="passwordInput" placeholder="Wachtwoord" />
