...
```
### Multi-tenancy
This project supports multi-tenancy, allowing you to use it for multiple organizations. Each organization has isolated data, and only an administrator can manage organizations.